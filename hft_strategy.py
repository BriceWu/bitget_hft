        ...
        while True:
            try:
                ...
                if self._bn_price_changed and (self._have_placed_order == 0.) and (self.v_volume_rate.value >1.) and len(self._bb_price_list) > 8:
                    if (0.25 > self.v_trade_side.value > 0.) and (self._bn_ask_one / self._bitget_bid_one < self._sell_profit_rate):
                    ...
                    elif (self.v_trade_side.value > 0.75) and (self._bn_bid_one / self._bitget_ask_one > self._buy_profit_rate):
                        self._have_placed_order = last_time
